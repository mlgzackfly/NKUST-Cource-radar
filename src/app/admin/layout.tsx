    ...
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "var(--ts-gray-100)" }}>
      ...
      >
        <div style={{ padding: "0 1.5rem", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--app-muted)" }}>{user.email}</p>
        </div>
        ...
        <nav>
          ...
          <AdminNavLink href="/admin/instructors" icon="👨‍🏫">
            教師儀表板
          </AdminNavLink>
          <AdminNavLink href="/admin/reports" icon="🚩">
            檢舉管理
          </AdminNavLink>
          ...
          <AdminNavLink href="/admin/actions" icon="📝">
            操作記錄
          </AdminNavLink>
          <AdminNavLink href="/admin/export" icon="📤">
            數據匯出
          </AdminNavLink>
