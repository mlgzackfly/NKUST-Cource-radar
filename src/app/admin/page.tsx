  ...
  return (
    <div className="ts-box is-raised" style={{ backgroundColor: "var(--ts-gray-50)" }}>
      <div className="ts-content" style={{ padding: "1.5rem" }}>
        <div style={{ fontSize: "1.125rem", fontWeight: 600, marginBottom: "1rem", color: "var(--ts-gray-700)" }}>
          {title}
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {items.map((item, idx) => (
            <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: "1.5rem", fontWeight: 700, color: item.color || "var(--ts-gray-800)" }}>
